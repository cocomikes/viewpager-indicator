...
public interface Indicator {
     ...
     * 目前提供的子类
     * {io.library.android.indicator.transition.OnTransitionTextListener}
     *
     ...
     * 设置滑动块<br>
     * 设置它可以自定义滑动块的样式。<br>
     * 目前提供的子类 {io.library.android.indicator.slidebar.ColorBar}
     * {io.library.android.indicator.slidebar.DrawableBar}
     * {io.library.android.indicator.slidebar.LayoutBar}
     *
     * @param scrollBar
     */
