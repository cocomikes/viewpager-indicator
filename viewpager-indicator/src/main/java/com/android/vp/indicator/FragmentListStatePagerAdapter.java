 ...
 * {Fragment} to manage each page. This class also handles saving and
 ...
 * with each visited page as compared to {FragmentPagerAdapter} at the
 * cost of potentially more overhead when switching between pages.
 * When using FragmentPagerAdapter the host ViewPager must have a valid ID set.
 * Subclasses only need to implement {#getItem(int)} and
 * {#getCount()} to have a working adapter.
 ...
 * complete}
 */
public abstract class FragmentListStatePagerAdapter extends PagerAdapter {
    private static final String TAG = "FragmentListState";
    ...
    public FragmentListStatePagerAdapter(FragmentManager fm) {
        mFragmentManager = fm;
    }
