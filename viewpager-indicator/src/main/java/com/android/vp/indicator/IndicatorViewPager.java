...
public class IndicatorViewPager {
     ...
     */
    public static abstract class IndicatorFragmentPagerStateAdapter extends LoopAdapter {
        public abstract View getViewForTab(int position, View convertView, ViewGroup container);
        public abstract Fragment getFragmentForPage(int position);

        private FragmentListStatePagerAdapter fragmentPageAdapter;
        private boolean loop;
        ...
        public IndicatorFragmentPagerStateAdapter(FragmentManager fragmentManager) {
            fragmentPageAdapter = new FragmentListStatePagerAdapter(fragmentManager) {
                @Override
                public int getCount() {
                    if (IndicatorFragmentPagerStateAdapter.this.getCount() == 0) {
                        return 0;
                    }
                    if (loop) {
                        return Integer.MAX_VALUE - 100;
                    }
                    return IndicatorFragmentPagerStateAdapter.this.getCount();
                }

                @Override
                public Fragment getItem(int position) {
                    return IndicatorFragmentPagerStateAdapter.this.getFragmentForPage(getRealPosition(position));
                }

                @Override
                public float getPageWidth(int position) {
                    return IndicatorFragmentPagerStateAdapter.this.getPageRatio(getRealPosition(position));
                }

                @Override
                public int getItemPosition(Object object) {
                    return IndicatorFragmentPagerStateAdapter.this.getItemPosition(object);
                }
            };
        }
        ...
        private Indicator.IndicatorAdapter indicatorAdapter = new Indicator.IndicatorAdapter() {
            ...
            @Override
            public View getView(int position, View convertView, ViewGroup parent) {
                return IndicatorFragmentPagerStateAdapter.this.getViewForTab(position, convertView, parent);
            }
        ...
        public Fragment getCurrentFragment() {
            return fragmentPageAdapter.getCurrentFragment();
        }
    ...
    public static abstract class IndicatorFragmentPagerAdapter extends LoopAdapter {
        ...
        private FragmentListPagerAdapter fragmentPageAdapter;
        private boolean loop;
        ...
        public IndicatorFragmentPagerAdapter(FragmentManager fragmentManager) {
            fragmentPageAdapter = new FragmentListPagerAdapter(fragmentManager) {
                @Override
                public int getCount() {
