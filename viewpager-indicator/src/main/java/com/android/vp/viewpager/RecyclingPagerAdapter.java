 ...
 * A {PagerAdapter} which behaves like an {android.widget.Adapter}
...
public abstract class RecyclingPagerAdapter extends PagerAdapter {
    ...
    public void finishUpdate(ViewGroup container) {
        try{
            ...
            Log.e("ViewPagerAdapter", "Catch the NullPointerException in FragmentPagerAdapter.finishUpdate,",nullPointerException);
        }
    }
     ...
     *         {#getView}. Note: Integers must be in the range 0 to
     *         {#getViewTypeCount} - 1. {#IGNORE_ITEM_VIEW_TYPE} can
     *         also be returned.
